...
function site_scripts() {
	...
	wp_enqueue_style( 'site-style-jquery-ui', "https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.css" );
	...
	wp_enqueue_script( 'site-script-site-base', get_template_directory_uri() .'/js/site-integration.js');
